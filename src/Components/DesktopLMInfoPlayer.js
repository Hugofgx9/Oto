...
const DesktopLMInfoPlayer = () => {
	return (
			<div className={ styles.gridLMInfo }>
				<img className={ styles.playedImg } src="https://images-na.ssl-images-amazon.com/images/I/710ZkhTLgJL._SY355_.jpg"/>
				<div className={ styles.playedTrack }>
					...
					<img className={ styles.like } src="../assets/heartfilled.png"/>
				</div>
			</div>
	);
}
